...
var getWeather = function() {
    ...
    // }
      ...
      // }
	  showWeather(24.774922,121.04497679999999); //Force lat and long
	  console.log("Force input geolocation DATA!!");
  }
 
  function showWeather(lat, long) {
    var url = `https://api.darksky.net/forecast/23991720eabe40f5f8a03528ae5a9c9e/${lat},${long}` + `?lang=zh-tw&format=jsonp&callback=displayWeather`;
...
var object;//object.currently.temperature
 ...
 function displayWeather(object) {
    ...
    temperature.innerHTML = farenheitToCelsius(object.currently.temperature) + " C" + "/" + "77.64" + " F";
